...
//  AUXILIARY FUNCTIONS
////==============================================================================================
// Mixed-kernel weights for a target observation (leave-one-out).
// [[Rcpp::export]]
...
////==============================================================================================
// Minimize multinomial logit objective using quasi-Newton steps.
vec mnlmin(size_t    n, 
           vec &b0, 
           vec &_wgt_bw,
           mat &_dpost,
...
//  GPS FUNCTIONS
////==============================================================================================
// Local logit GPS fit using kernel weights.
// [[Rcpp::export]]
...
////===============================================================================================
// Local least-squares GPS fit using kernel weights.
// [[Rcpp::export]]
...
////===============================================================================================
// Objective for GPS bandwidth selection via cross-validation.
class LocPolPs : public Functor {
public:
  LocPolPs(const  mat & dpost,
           const  mat & cov,
           const  vec & dim_x,
...
////===============================================================================================
// Cross-validated bandwidth selection for GPS.
// [[Rcpp::export]]
Rcpp:: List cv_ps( mat         &dpost,
  ...
  LocPolPs OBJ_cv_ps(dpost, cov, dim_x, bw_method, lp_method);
  Roptim<LocPolPs> opt("Nelder-Mead");
...
////===============================================================================================
// Fit GPS with supplied bandwidths.
// [[Rcpp::export]]
...
//  OR FUNCTIONS
////==============================================================================================
// Local OR fit with shared bandwidths across groups.
// [[Rcpp::export]]
...
////===============================================================================================
// Local OR fit for a single group (unconstrained).
// [[Rcpp::export]]
...
////===============================================================================================
// Objective for OR bandwidth selection via cross-validation.
class LocPolOr : public Functor {
public:
  LocPolOr(const  mat &dpost, 
           const  mat &dty, 
           const  mat &cov, 
           const  vec &dim_x,
           const  int &or_index) :
...
////===============================================================================================
// Cross-validated bandwidth selection for OR.
// [[Rcpp::export]]
Rcpp:: List cv_or( mat      &dpost, 
  ...
  LocPolOr OBJ_cv_or(dpost, dty, cov, dim_x, or_index);
  Roptim<LocPolOr> opt("Nelder-Mead");
...
////===============================================================================================
// Fit OR with supplied bandwidths; returns per-group or full matrix.
// [[Rcpp::export]]

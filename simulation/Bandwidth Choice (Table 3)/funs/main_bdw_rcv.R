# =============================================================================
# main_bdw_rcv.R  --  Bandwidth-comparison Monte Carlo (Table 3), RCV
#
# Section 5 bandwidth study. Runs the Monte Carlo for the RCV bandwidth
# selector across DGPs 1, 2, 3 (delta = c(0, 1, 0.5)[dgp]) at n = 1000,
# jobs 0-9, by sourcing funs/sim_bdw_rcv.R.
#
# Companion drivers main_bdw_loocv.R and main_bdw_plugin.R run the LOOCV and
# plug-in selectors. Sources the shared core backend from ../core; results are
# written to results/rcv/ and aggregated into Table 3 by
...
address <- "./simulation/Bandwidth Choice (Table 3)"  # EDIT to your local simulation/<scenario> path
setwd(address)
...
#-----------------------------------------------------------------------------
# Source Rcpp file
Rcpp::sourceCpp(file.path(CORE, "np_lp_rcv.cpp"))

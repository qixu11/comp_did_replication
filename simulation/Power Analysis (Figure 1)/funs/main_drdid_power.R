...
here::i_am("simulation/Power Analysis (Figure 1)/funs/main_drdid_power.R")
address <- here::here("simulation", "Power Analysis (Figure 1)")
...
for (nn in 3:3){
    ...
    for (delta in seq(0, 1, 0.05)){ #Controls deviation from the null of NCC condition
      ...
      #do the Monte Carlo
      source(file.path(address, "funs", "sim_power.R"))
